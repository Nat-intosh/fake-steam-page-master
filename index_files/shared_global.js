...
function UpdateNotificationCounts()
{
	...
	if ( $NotificationItems.length || $NotificationTotalCounts.length )
	{
		$J.ajax( GetDefaultCommunityAJAXParams( 'index_files/GetNotificationCounts.json', 'GET' ) ).done( function( data ) {
	...
	if ( bNewPopup )
	{
		...
		if ( paramsFriendsUI )
		{
			var fnBoundMessageListener = function( event )
			{
				...
				{
					winChat.postMessage( paramsFriendsUI, '' );
